/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `letterSpacings.${LetterSpacingToken}` | `shadows.${ShadowToken}` | `blurs.${BlurToken}` | `sizes.${SizeToken}` | `animations.${AnimationToken}` | `colors.${ColorToken}` | `spacing.${SpacingToken}` | `radii.${RadiusToken}` | `fontSizes.${FontSizeToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `fonts.${FontToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "black" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "white" | "sky" | "lavender" | "sand" | "ink" | "page" | "panel" | "panelMuted" | "text" | "textMuted" | "line" | "accent" | "accentSoft" | "accentContrast" | "secondaryAccent" | "secondaryAccentSoft"
...
export type FontSizeToken = "2xs" | "7xl" | "8xl" | "9xl" | "xs" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "4xl" | "5xl" | "6xl"

export type FontWeightToken = "thin" | "extralight" | "light" | "normal" | "extrabold" | "black" | "regular" | "medium" | "semibold" | "bold"

export type LineHeightToken = "none" | "loose" | "tight" | "snug" | "normal" | "relaxed"
