const tokens = {
  ...
  "colors.lavender.600": {
    "value": "#775ec9",
    "variable": "var(--colors-lavender-600)"
  },
  "colors.sand.50": {
    "value": "#fffaf2",
    "variable": "var(--colors-sand-50)"
  },
  "colors.sand.100": {
    "value": "#f5ebdb",
    "variable": "var(--colors-sand-100)"
  },
  "colors.sand.200": {
    "value": "#e8d6bd",
    "variable": "var(--colors-sand-200)"
  },
  "colors.sand.400": {
    "value": "#c7a67a",
    "variable": "var(--colors-sand-400)"
  },
  "colors.ink.50": {
    "value": "#f6f7fb",
  ...
  "fonts.display": {
    "value": "\"A2Z\", \"Pretendard\", sans-serif",
  ...
  "colors.panelMuted": {
    "value": "var(--colors-sand-50)",
    "variable": "var(--colors-panel-muted)"
  },
  "colors.text": {
    "value": "var(--colors-ink-900)",
    "variable": "var(--colors-text)"
  },
  "colors.textMuted": {
    "value": "var(--colors-ink-600)",
    "variable": "var(--colors-text-muted)"
  },
  "colors.line": {
    "value": "var(--colors-sky-200)",
  ...
  "colors.accentSoft": {
    "value": "var(--colors-sky-100)",
    "variable": "var(--colors-accent-soft)"
  },
  ...
  "colors.secondaryAccent": {
    "value": "var(--colors-lavender-600)",
    "variable": "var(--colors-secondary-accent)"
  },
  "colors.secondaryAccentSoft": {
    "value": "var(--colors-lavender-100)",
    "variable": "var(--colors-secondary-accent-soft)"
  },
  "spacing.-1": {
